...
namespace Homework.CSharpOop.Class04.Task2.RemoveExtraSpaceChar
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string str = "The    best  Lorem  Ipsum        Generator in all the  sea!   Heave this   scurvy copyfiller fer yar         next   adventure  and cajol yar clients   into walking the plank with ev'ry layout!    Configure       above, then get yer pirate ipsum...own the high seas,    argh!";
